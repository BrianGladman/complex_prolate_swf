...
!               for a specified number lnum of degrees l = m, m+1,..., m+lnum-1
!
...
!
!  scalars
        real(knd) aj1, aj2, ang, apcoef, apcoefn, api, c, coefme, coefmo, &
...
if (debug) then
                if(iopang == 1) write(50, 740) &
                       barg(jarg), naccs(jarg)
                if(iopang == 2) write(50, 745) &
